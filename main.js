...
function __asyncjs__loadLibrary(libname_cpp) { return Asyncify.handleAsync(async () => { const libname = UTF8ToString(libname_cpp); const imports = { }; const importObject = { wasi_snapshot_preview1: imports, env : imports }; const result = await WebAssembly.instantiateStreaming(fetch(libname), importObject); window["module_" + libname] = {}; Object.assign(window["module_" + libname], result.instance.exports); }); }
...
var asmLibraryArg = {
  ...
  "__asyncjs__loadLibrary": __asyncjs__loadLibrary,
...
var ___start_em_js = Module['___start_em_js'] = 17508;
var ___stop_em_js = Module['___stop_em_js'] = 17912;
